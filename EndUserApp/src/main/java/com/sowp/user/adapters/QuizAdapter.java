...
public class QuizAdapter extends RecyclerView.Adapter<QuizAdapter.QuizViewHolder> {
    ...
    public static class QuizViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView tvQuizCategories;
        private final TextView tvQuizTags;
        ...
        public QuizViewHolder(@NonNull View itemView) {
            ...
            tvQuizCategories = itemView.findViewById(R.id.tvQuizCategories);
            tvQuizTags = itemView.findViewById(R.id.tvQuizTags);
        ...
        void bind(Quiz quiz, OnQuizClickListener listener) {
            ...
            tvQuizCategories.setText(quiz.getCategories() != null ? quiz.getCategories() : "General");
            tvQuizTags.setText(quiz.getTags() != null ? quiz.getTags() : "No tags");
